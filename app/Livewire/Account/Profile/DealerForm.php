...
{
    public $dealer_stock_service, $join_dealer_network, $opt_out_dealer_network;
    ...
    public function updatedOptOutDealerNetwork(){
        if($this->opt_out_dealer_network){
            $this->dispatch('show-opt-out-confirmation');
        }
    }
