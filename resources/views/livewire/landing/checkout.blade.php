                ...
                <div class="col-md-12 mt-4">
                    <div class="form-check">
                        ...
                        <label class="form-check-label" for="terms_check">
                            <small>I acknowledge that I have read and understood the Terms and Conditions. I confirm that I am legally authorized to use this platform and that I will comply with all applicable South African laws, including the Firearms Control Act (60), 2020. I understand that I am solely responsible for ensuring compliance with all relevant regulations and laws.</small>
                        </label>
                    </div>
                </div>
