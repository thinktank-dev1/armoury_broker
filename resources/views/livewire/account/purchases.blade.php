                    ...
                    <table class="table table-borderless mb-0 me-5">
                        <thead class="p-0 m-0">
                            <tr class="p-0 m-0">
                                ...
                                <th class="p-0 m-0 w-14">R {{ number_format($order->totalPaid(), 2) }}<br/><small>Amount Paid</small></th>
                            </tr>
                        </thead>
                    </table>
                </button>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="@if($item->product->images->count() > 0) col-md-6 @else col-md-12 @endif mt-3">
                                            <table class="table table-borderless">
                                                <tbody>
                                                    <tr><th class="p-0">Vendor:</th><td class="p-0"><a href="{{ url('/'.$item->product->vendor->url_name) }}">{{ $item->product->vendor->name }}</a></td></tr>
